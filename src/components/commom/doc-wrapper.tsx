...
const DocWrapper = ({ children, doc, url, editMode }) => {
    ...
    return (
        <div className="p-6">
            ...
            <p className="text-sm">
                Sit amet dictum sit amet. Consectetur a erat nam at. Et malesuada fames ac turpis. Elit eget gravida cum sociis
                natoque penatibus et magnis dis. Porta non pulvinar neque laoreet suspendisse interdum consectetur libero id.
                Ridiculus mus mauris vitae ultricies leo. Mauris vitae ultricies leo integer malesuada nunc vel. Gravida dictum
                fusce ut placerat orci. Lacinia at quis risus sed. Ut consequat semper viverra nam libero justo laoreet sit amet.
            </p>
