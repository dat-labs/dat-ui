...
const StreamPanel: React.FC<StreamPanelProps> = ({
    ...
    const [targetPath, setTargetPath] = useState<string | null>(null); // State for targetPath
    ...
    useEffect(() => {
        const fetchSessionData = async () => {
            ...
            const user_id = session?.user?.id; // Make sure session exists and user_id is not undefined
